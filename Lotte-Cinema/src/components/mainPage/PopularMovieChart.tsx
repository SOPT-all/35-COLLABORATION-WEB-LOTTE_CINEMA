...
const PopularMovieChart = () => {
  return (
    <>
      ...
      <S.ContentWrapper>
        <S.EachContentWrapper>
          ...
          <S.GridContainer>
            ...
            <S.StarReview><IcStarGray1010 width="1rem" height="1rem"/>4.7</S.StarReview>
          </S.GridContainer>
      ...
      <S.EntireMovieSelect>전체 보기 <IcArrowRightGray0910 height="1rem" width="1rem"/></S.EntireMovieSelect>
    </>
  );
};
